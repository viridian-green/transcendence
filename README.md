*This project has been created as part of the 42 curriculum by schardot, pebencze, vados-sa, viridian-green, ProjectDaiana.*
...
The goal of this project is to build a complete web application featuring:
...
- Social features including friend management and presence tracking
- A modern, responsive retro-themed user interface
...
|---------|----------------|-------------|
| **User Authentication** | Natália, Adèle, Daiana | Secure registration, login, and logout functionality with JWT token-based sessions and HTTP-only cookies for XSS protection |
| **User Profiles** | Natália, Daiana, Petra | Profile page displaying user information, avatar upload with image processing, editable bio, and account settings management |
| **Friends System** | Petra, Daiana, Natália | Send/accept/decline friend requests, view friends list, unfriend users, with real-time status updates |
| **Real-time Chat** | Daiana, Natália, Adèle | WebSocket-based instant messaging system with chat widget, message history, and online user indicators |
| **Presence System** | Natália, Daiana | Real-time tracking of user status (online/offline/in-game) using Redis pub/sub for instant updates across all clients |
| **Notifications** | Natália, Adèle, Daiana | Real-time push notifications for friend requests, game invitations, and system alerts via WebSocket |
| **Pong Game** | Adèle, Vanessa, Petra | Classic Pong with three modes: local multiplayer (two players, same device), AI opponent, and online multiplayer with WebSocket sync |
| **Frontend UI/Design** | Daiana, Petra, Adèle | Retro-themed responsive interface with custom components, animations, and consistent design system |
| **API Gateway** | Natália, Daiana, Adèle | Central routing layer handling authentication, request forwarding, and service orchestration |
| **DevOps/Infrastructure** | Natália, Daiana, Adèle | Docker containerization, Nginx reverse proxy, SSL certificates, CI/CD pipeline, and deployment configuration |
...
**Team Members:** Daiana (chat), Natália/Petra (profiles), Petra/Daiana/Natália (friends)
</details>
...
**Team Members:** Natália, Adèle, Daiana
</details>
...
**Team Members:** Adèle, Natália, Daiana
</details>
...
|--------|-------|---------|------------------|
| **Daiana** | ProjectDaiana | Product Owner, Developer | Defines product vision, prioritizes features, manages backlog, and participates in development |
...
| **Natália** | schardot | Developer | Full-stack development, feature implementation, and code maintenance |
| **Petra** | pebencze | Developer | Full-stack development, feature implementation, and code maintenance |
| **Adèle** | viridian-green | Developer | Full-stack development, feature implementation, and code maintenance |
...
- **Biweekly Meetings** — Regular sync meetings every two weeks to review progress, discuss blockers, and plan upcoming work
- **Kanban Board** — Visual task management using GitHub Projects to track work status (To Do → In Progress → Review → Done)
...
<details>
<summary><strong>Natália (schardot)</strong> — Developer</summary>

#### Primary Contributions
| Area | Role | Details |
|------|------|---------|
| **User Authentication** | Lead | Implemented JWT-based auth system, secure login/logout, HTTP-only cookies, bcrypt password hashing |
| **User Service** | Lead | Built user profiles, avatar upload, bio management, account settings |
| **API Gateway** | Lead | Designed routing layer, authentication middleware, service orchestration |
| **Presence Service** | Co-lead | Redis integration for real-time status tracking, WebSocket connection handling |
| **DevOps** | Lead | Docker configuration, docker-compose setup, CI/CD pipeline, SSL certificate generation |
...
<details>
<summary><strong>Daiana (ProjectDaiana)</strong> — Product Owner, Developer</summary>

#### Primary Contributions
| Area | Role | Details |
|------|------|---------|
| **Real-time Chat** | Lead | Built complete chat service, WebSocket handlers, chat widget UI, message broadcasting |
| **User Profiles** | Contributor | Profile page components, profile data display |
| **Friends System** | Contributor | Friend request handling, friends list integration |
| **Frontend UI** | Co-lead | Component development, page layouts, styling |
| **DevOps** | Contributor | Docker configuration, Makefile commands, deployment setup |
...
| Area | Role | Details |
|------|------|---------|
| **Friends System** | Lead | Friend requests, accept/decline logic, friends list, unfriend functionality |
| **Frontend UI/Design** | Lead | Custom design system, reusable components, retro theme implementation |
| **User Profiles** | Contributor | Profile page UI, settings interface |
| **Pong Game** | Contributor | Game UI components, canvas styling |
...
<details>
<summary><strong>Adèle (viridian-green)</strong> — Developer</summary>

#### Primary Contributions
| Area | Role | Details |
|------|------|---------|
| **Pong Game (Local)** | Lead | Game logic, canvas rendering, keyboard controls, collision detection |
| **Pong Game (Online)** | Lead | WebSocket game state sync, multiplayer logic, matchmaking |
...
| Area | Role | Details |
|------|------|---------|
| **AI Opponent** | Lead | AI paddle movement logic, difficulty balancing, human-like behavior simulation |
| **Pong Game** | Contributor | Game features, testing, refinements |
| **Frontend** | Contributor | UI components, page implementations |
...
- Ensured AI works with all game customization options
...
| Team Member | Primary Areas | Commit Activity |
|-------------|---------------|-----------------|
| **Natália** | Auth, User Service, API Gateway, DevOps | Highest overall (backend focus) |
| **Daiana** | Chat, Frontend UI, DevOps | Second highest (full-stack) |
| **Petra** | Friends System, Design System, Frontend | Frontend-focused |
| **Adèle** | Game Engine, Multiplayer, Notifications | Game-focused |
| **Vanessa** | AI Opponent, Game Features | AI/Game-focused |
