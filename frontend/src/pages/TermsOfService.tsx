	...
	return (
		<div className='policy-and-terms-pages'>
			<article>
				...
				<p>
					The Game is provided on an <strong>as-is</strong> basis for educational and
					testing purposes.
				</p>
				...
				<p>
					The Game may allow user accounts that include a username, profile picture, and
					email address.
				</p>
				...
				<p>
					The developers are not responsible for any data loss, errors, or damages
