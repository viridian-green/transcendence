        ...
        ws.current.onmessage = (event) => {
            ...
            try {
                ...
                if (data.type === "userStateChanged" && data.userId && data.state) {
                    ...
                    console.log('[PRESENCE SOCKET] Set status (userStateChanged):', String(data.userId), data.state);
                }
                ...
                if (data.type === "presence_update" && Array.isArray(data.users)) {
                    ...
                    for (const user of data.users) {
                        ...
                        console.log('[PRESENCE SOCKET] Set status (presence_update):', String(user.id), user.status);
                    }
