...
export async function emitFriendAccepted(app, fromUserId, toUserId) {
    ...
    console.log('[EMIT FRIEND ACCEPTED] Publishing event:', { fromId, toId, fromIdType: typeof fromId, toIdType: typeof toId });
    ...
    console.log('[EMIT FRIEND ACCEPTED] Event object:', JSON.stringify(event, null, 2));
    ...
    console.log('[EMIT FRIEND ACCEPTED] Published to Redis');
}
